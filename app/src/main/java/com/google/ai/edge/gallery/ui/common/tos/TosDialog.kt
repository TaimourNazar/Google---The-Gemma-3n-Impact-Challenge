    ...
    Card(shape = RoundedCornerShape(28.dp)) {
      Column(modifier = Modifier.padding(horizontal = 24.dp)) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState()).weight(1f, fill = false)) {
          // Short content.
          MarkdownText(
            "By using Bio Protect, you accept the App's Terms of Service" +
          ...
          if (viewFullTerms) {
            MarkdownText(
              "Your use of any Gemma models in the Bio Protect app is governed by the [Gemma Terms of Use](https://ai.google.dev/gemma/terms), including the [Gemma Prohibited Use Policy](https://ai.google.dev/gemma/prohibited_use_policy). By using, reproducing, modifying, distributing, performing, or displaying any portion or element of Gemma or any Gemma model derivatives, you agree to be bound by [those terms](https://ai.google.dev/gemma/terms) and that policy.\n" +
                "\n" +
                "Your use of any other AI models in Bio Protect is subject to the terms and conditions that apply to that model. Please read those terms carefully before using any third-party model.\n" +
                "\n" +
                "We will not be responsible for any mistake or damage. Always consult an expert before taking any action. AI models can make mistakes.",
              smallFontSize = true,
